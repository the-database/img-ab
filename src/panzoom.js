...
import createTextSelectionInterceptor from './lib/makeTextSelectionInterceptor';
...
import makeSvgController, { canAttach as svgCanAttach } from './lib/makeSvgController';
import makeDomController, { canAttach as domCanAttach } from './lib/makeDomController';
...
export default function createPanZoom(domElement, options) {
  ...
  if (!panController) {
    if (svgCanAttach(domElement)) {
      panController = makeSvgController(domElement, options);
    } else if (domCanAttach(domElement)) {
